...
var favoriteBook = Book(title: "Ready Player One", author: "Ernest Cline", pages: 384, price: 4.99)
print("My favorite book is \(favoriteBook.title) and is written by \(favoriteBook.author). The book has \(favoriteBook.pages) pages and currently is priced on amazon.co.uk at £\(favoriteBook.price)" )
...
myHeight = Height(heightInCentimeters: 177.8)
