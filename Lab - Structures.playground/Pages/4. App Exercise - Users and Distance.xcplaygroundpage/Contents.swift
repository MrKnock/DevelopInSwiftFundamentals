 ...
 */
var Ted = User(name: "Ted", age: 30, height: 177.8, weight: 92, activityLevel: 7)
print("Hello \(Ted.name). Currently you are \(Ted.age) years old. You are \(Ted.height) centimeters tall and weight \(Ted.weight) kilos. You are working at an activity level of \(Ted.activityLevel).")
/*:
 ...
 */
var range = Distance(feet: 5249.344)
print(range.meters)
